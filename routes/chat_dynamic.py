...
try:
    from services.mia_chat_service_full_menu_with_tools_upgraded import mia_chat_service_full_menu_with_tools_upgraded as generate_response_full_menu_with_tools
    chat_services['full_menu_with_tools'] = generate_response_full_menu_with_tools
    logger.info("Loaded full menu with tools service (upgraded with dietary)")
except ImportError as e:
